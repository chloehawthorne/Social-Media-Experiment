...
using Octo_Social_Media;
using Octo_Social_Media.Droid.Renderers;

[assembly: ExportRenderer(typeof(ExtendedEditorControl), typeof(CustomEditorRenderer))]
namespace Octo_Social_Media.Droid.Renderers
{
    public class CustomEditorRenderer : EditorRenderer
    {
        ...
        //Max number of texts that can be viewed before the user needs to scroll
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Editor> e)
        {
            ...
            //If new instance of text message has appeared, apply certain styles and a place holder
        ...
        //Applies border using drawing properites
        void ApplyBorder()
        {
